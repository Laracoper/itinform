    ...
    <div class="wrapper">
        <header class="header block-header">
            <div class="block-header__container">
                <a href="{{route('home')}}" class="block-header__logo">
                ...
                <nav class="block-header__menu menu">
                    ...
                    <ul class="menu__list">
                        ...
                        <li><a class='menu__link' href="{{route('courses')}}">Курсы</a></li>
                        <li><a href="{{route('opening')}}" class="menu__link">Расписание</a></li>
                        <li><a class='menu__link' href="{{route('teachers')}}">Преподаватели</a></li>
                        <li><a href="#jj" class="menu__link">Рассылка</a></li>
                        <li><a href="{{route('contact')}}" class="menu__link">Контакты</a></li>
                    </ul>
                </nav>
